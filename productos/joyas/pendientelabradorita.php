...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=114";
        ...
        $precio = "SELECT precio FROM productos WHERE id=114";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=114";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=114";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=114";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=163";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=114";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=114";
...
<head>
    ...
    <title>Místico - Pendientes de Labradorita</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Pendientes de Obsidiana Nevada y Plata de Ley</h5>
                        <p>9,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Pendientes Cuarzo Rutilado y Plata de Ley</h5>
                        <p>9,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Pendientes Hoops Jaspe rojo y Plata de Ley</h5>
                        <p>18,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Pendientes Hoops Cuarzo Verde y Plata de Ley</h5>
                        <p>18,00€</p>
                    </div>
