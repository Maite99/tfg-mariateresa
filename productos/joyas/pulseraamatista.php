...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=79";
        ...
        $precio = "SELECT precio FROM productos WHERE id=79";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=79";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=79";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=79";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=127";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=79";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=79";
...
<head>
    ...
    <title>Místico - Pulsera de Amatista</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Pulsera de Aguamarina Natural</h5>
                        <p>15,50€</p>
                    </div>
