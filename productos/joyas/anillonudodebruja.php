...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=97";
        ...
        $precio = "SELECT precio FROM productos WHERE id=97";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=97";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=97";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=97";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=146";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=97";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=97";
...
<head>
    ...
    <title>Místico - Anillo de Nudo de Bruja</title>
</head>
<body>
