...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=90";
        ...
        $precio = "SELECT precio FROM productos WHERE id=90";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=90";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=90";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=90";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=139";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=90";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=90";
...
<head>
    ...
    <title>Místico - Collar de Ágata Natural</title>
</head>
<body>
