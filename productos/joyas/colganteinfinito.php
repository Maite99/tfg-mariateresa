...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=109";
        ...
        $precio = "SELECT precio FROM productos WHERE id=109";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=109";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=109";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=109";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=158";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=109";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=109";
...
<head>
    ...
    <title>Místico - Colgante de Infinito</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Colgante Estrella Merkaba Ojo de Tigre en Plata de Ley</h5>
                        <p>12,90€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Colgante Biterminado de Amatista</h5>
                        <p>17,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Colgante de Tanzanita y Plata de Ley</h5>
                        <p>15,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Colgante Punta Cuarzo Cristal de Roca y Plata de Ley</h5>
                        <p>16,90€</p>
                    </div>
