...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=92";
        ...
        $precio = "SELECT precio FROM productos WHERE id=92";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=92";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=92";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=92";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=140";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=92";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=92";
...
<head>
    ...
    <title>Místico - Collar de Piedra Malaquita</title>
</head>
<body>
        ...
        <section class="productos-relacionados mt-5 mb-5">
            <div class="container">
                ...
                <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Collar Corazon de Ágata Natural en Plata de Ley</h5>
                        <p>29,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Collar de Plata de Ley con Piedra Malaquita</h5>
                        <p>35,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Collar de Cuarzo Rosa con Calcita Amarilla en Plata 925</h5>
                        <p>35,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Collar Corazon de Cuarzo Turmalinado en Plata de Ley</h5>
                        <p>35,00€</p>
                    </div>
