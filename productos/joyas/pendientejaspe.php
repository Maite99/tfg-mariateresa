...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=117";
        ...
        $precio = "SELECT precio FROM productos WHERE id=117";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=117";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=117";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=117";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=166";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=117";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=117";
...
<head>
    ...
    <title>Místico - Pendientes de Jaspe </title>
</head>
<body>
