...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=95";
        ...
        $precio = "SELECT precio FROM productos WHERE id=95";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=95";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=95";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=95";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=143";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=95";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=95";
...
<head>
    ...
    <title>Místico - Anillo con Amatista</title>
</head>
<body>
