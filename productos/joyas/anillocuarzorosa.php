...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=102";
        ...
        $precio = "SELECT precio FROM productos WHERE id=102";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=102";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=102";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=102";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=151";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=102";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=102";
...
<head>
    ...
    <title>Místico - Anillo con Cuarzo Rosa</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Anillo de Plata de Ley Nudo de Bruja</h5>
                        <p>16,90€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Anillo de Plata de Ley Flor de Vida</h5>
                        <p>15,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Anillo de Plata de Ley Floreteado con Labradorita</h5>
                        <p>19,50€</p>
                    </div>
