...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=93";
        ...
        $precio = "SELECT precio FROM productos WHERE id=93";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=93";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=93";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=93";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=141";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=93";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=93";
...
<head>
    ...
    <title>Místico - Collar de Cuarzo Rosa</title>
</head>
<body>
