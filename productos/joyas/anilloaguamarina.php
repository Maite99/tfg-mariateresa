...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=101";
        ...
        $precio = "SELECT precio FROM productos WHERE id=101";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=101";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=101";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=101";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=150";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=101";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=101";
...
<head>
    ...
    <title>Místico - Anillo con Aguamarina</title>
</head>
<body>
