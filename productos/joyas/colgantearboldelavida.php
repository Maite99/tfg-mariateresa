...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=107";
        ...
        $precio = "SELECT precio FROM productos WHERE id=107";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=107";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=107";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=107";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=156";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=107";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=107";
...
<head>
    ...
    <title>Místico - Colgante Árbol de la Vida</title>
</head>
<body>
