...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=85";
        ...
        $precio = "SELECT precio FROM productos WHERE id=85";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=85";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=85";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=85";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=134";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=";85
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=85";
...
<head>
    ...
    <title>Místico - Pulsera chips de Lapislazuli</title>
</head>
<body>
