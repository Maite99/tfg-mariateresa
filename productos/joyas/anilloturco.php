...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=99";
        ...
        $precio = "SELECT precio FROM productos WHERE id=99";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=99";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=99";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=99";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=148";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=99";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=99";
...
<head>
    ...
    <title>Místico - Anillo con Ojo Turco</title>
</head>
<body>
