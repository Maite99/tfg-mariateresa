...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=87";
        ...
        $precio = "SELECT precio FROM productos WHERE id=87";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=87";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=87";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=87";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=136";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=87";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=87";
...
<head>
    ...
    <title>Místico - Collar de Sodalita</title>
</head>
<body>
        ...
        <section class="productos-relacionados mt-5 mb-5">
            <div class="container">
                ...
                <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Collar Punta de Cuarzo Lemuriano en Plata de Ley</h5>
                        <p>39,00€</p>
                    </div>
