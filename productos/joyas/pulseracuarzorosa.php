...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=81";
        ...
        $precio = "SELECT precio FROM productos WHERE id=81";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=81";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=81";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=81";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=130";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=81";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=81";
...
<head>
    ...
    <title>Místico - Pulsera de Cuarzo Rosa</title>
</head>
<body>
