...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=110";
        ...
        $precio = "SELECT precio FROM productos WHERE id=110";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=110";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=110";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=110";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=159";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=110";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=110";
...
<head>
    ...
    <title>Místico - Colgante de Estrella</title>
</head>
<body>
