...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=82";
        ...
        $precio = "SELECT precio FROM productos WHERE id=82";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=82";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=82";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=82";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=131";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=82";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=82";
...
<head>
    ...
    <title>Místico - Pulsera de Labradorita</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Pulsera roja de los 7 Nudos y Nudo de Bruja</h5>
                        <p>3,60€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Pulsera blanca de los 7 Nudos</h5>
                        <p>5,25€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Pulsera chips de Lapislazuli</h5>
                        <p>6,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Pulsera chips de Fluorita Arco Iris</h5>
                        <p>4,00€</p>
                    </div>
