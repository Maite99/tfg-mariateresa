...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=116";
        ...
        $precio = "SELECT precio FROM productos WHERE id=116";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=116";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=116";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=116";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=116";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=116";
...
<head>
    ...
    <title>Místico - Pendientes de Cuarzo Rutilado</title>
</head>
<body>
