...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=96";
        ...
        $precio = "SELECT precio FROM productos WHERE id=96";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=96";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=96";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=96";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=145";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=96";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=96";
...
<head>
    ...
    <title>Místico - Anillo con Labradorita</title>
</head>
<body>
