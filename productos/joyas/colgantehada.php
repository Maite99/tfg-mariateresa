...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=108";
        ...
        $precio = "SELECT precio FROM productos WHERE id=108";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=108";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=108";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=108";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=157";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=108";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=108";
...
<head>
    ...
    <title>Místico - Colgante de Hada en Luna</title>
</head>
<body>
