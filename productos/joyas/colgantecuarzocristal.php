...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=105";
        ...
        $precio = "SELECT precio FROM productos WHERE id=105";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=105";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=105";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=105";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=154";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=105";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=105";
...
<head>
    ...
    <title>Místico - Colgante de Cuarzo Cristal</title>
</head>
<body>
