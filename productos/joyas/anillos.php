                 ...
                 <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                     <div class="carousel-inner carrusel-principal mb-5">
                         <div class="carousel-item active">
                             <img src="../../img/portada-anillos.png" class="d-block w-100 img-carrusel" style="width: 800px; height: auto;" alt="...">
                         </div>
                     </div>
                 </div>
             <!-- FINAL FOTO -->
                     ...
                     <div class="row">
                         <div class="col-12 ps-lg-5 ">
                             <div class="caja-texto-productos">
                                 <h2>🔮 Anillos Esotéricos: Encanto en tu Mano</h2>
                                 <p class="mt-lg-2 texto1-productos">Explora nuestros anillos esotéricos, pequeñas obras maestras llenas de significado y magia. Cada anillo está imbuido con símbolos antiguos y energías sutiles que te acompañan en tu jornada espiritual.</p>
                                 <p class="mt-lg-2 texto2-productos">Descubre nuestra colección de anillos cuidadosamente diseñados, desde aquellos adornados con cristales hasta otros grabados con símbolos sagrados. Cada joya es una invitación a la conexión con lo divino y una herramienta para potenciar tu intuición y tu sabiduría interior.</p>
                                 <p class="mt-lg-2 texto-3"> <strong>¡Lleva contigo la magia de nuestros anillos esotéricos y deja que tu mano brille con el poder del universo! ✨💍</strong> </p>	
                             </div>
                 ...
                 <div class="container">
                     ...
                     <div class="row  d-flex flex-row ">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="anilloamatista.php">
                                 <img src="../../img/anillo-amatista.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Anillo de Plata de Ley con Amatista</h6>
                             <p class="precio">14,90€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="anilloladradorita.php">
                                 <img src="../../img/anillo-labradorita.jpeg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Anillo de Plata de Ley Floreteado con Labradorita</h6>
                             <p class="precio">19,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="anillonudodebruja.php">
                                 <img src="../../img/anillo-nudodebruja.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Anillo de Plata de Ley Nudo de Bruja</h6>
                             <p class="precio">16,90€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="anilloflordevida.php">
                                 <img src="../../img/anillo-florvida.jpeg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Anillo de Plata de Ley Flor de Vida</h6>
                     ...
                     <div class="row  d-flex flex-row mt-2">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             ...
                             <h6 class="texto-productos mt-2">Anillo de Plata de Ley Ojo Turco</h6>
                         ...
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             ...
                             <h6 class="texto-productos mt-2">Anillo de Plata de Ley Pluma</h6>
                         ...
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             ...
                             <h6 class="texto-productos mt-2">Anillo de Plata de Ley con Aguamarina</h6>
                             <p class="precio">25,80€ </p>
                         </div>
                         ...
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             ...
                             <h6 class="texto-productos mt-2">Anillo de Plata de Ley con Cuarzo Rosa </h6>
                             <p class="precio">25,80€ </p>
                         </div>
                     </div>
                 </div>
