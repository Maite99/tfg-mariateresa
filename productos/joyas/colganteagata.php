...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=104";
        ...
        $precio = "SELECT precio FROM productos WHERE id=104";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=104";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=104";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=104";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=153";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=104";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=104";
...
<head>
    ...
    <title>Místico - Colgante de Ágata Calcedonia</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Colgante Árbol de la Vida de Plata de Ley</h5>
                        <p>17,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Colgante Hada en Luna de Plata de Ley</h5>
                        <p>20,50€</p>
                    </div>
