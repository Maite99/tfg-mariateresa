...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=86";
        ...
        $precio = "SELECT precio FROM productos WHERE id=86";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=86";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=86";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=86";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=135";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=86";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=86";
...
<head>
    ...
    <title>Místico - Pulsera chips de Fluorita Arco Iris</title>
</head>
<body>
