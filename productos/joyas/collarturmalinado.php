...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=94";
        ...
        $precio = "SELECT precio FROM productos WHERE id=94";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=94";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=94";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=94";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=142";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=94";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=94";
...
<head>
    ...
    <title>Místico - Collar de Cuarzo Turmalinado</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Collar Corazon de Amatista en Plata de Ley</h5>
                        <p>29,00€</p>
                    </div>
