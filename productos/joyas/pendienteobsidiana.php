...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=115";
        ...
        $precio = "SELECT precio FROM productos WHERE id=115";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=115";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=115";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=115";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=115";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=115";
...
<head>
    ...
    <title>Místico - Pendientes de Obsidiana</title>
</head>
<body>
