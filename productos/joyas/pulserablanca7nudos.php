...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=84";
        ...
        $precio = "SELECT precio FROM productos WHERE id=84";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=84";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=84";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=84";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=133";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=84";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=84";
...
<head>
    ...
    <title>Místico - Pulsera Blanca 7 Nudos</title>
</head>
<body>
