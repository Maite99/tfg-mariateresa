...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=100";
        ...
        $precio = "SELECT precio FROM productos WHERE id=100";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=100";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=100";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=100";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=149";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=100";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=100";
...
<head>
    ...
    <title>Místico - Anillo de Pluma</title>
</head>
<body>
