...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=91";
        ...
        $precio = "SELECT precio FROM productos WHERE id=91";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=91";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=91";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=91";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=144";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=91";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=91";
...
<head>
    ...
    <title>Místico - Collar de Amatista</title>
</head>
<body>
