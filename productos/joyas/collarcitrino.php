...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=89";
        ...
        $precio = "SELECT precio FROM productos WHERE id=89";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=89";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=89";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=89";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=138";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=89";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=89";
...
<head>
    ...
    <title>Místico - Collar de Citrino Natural</title>
</head>
<body>
