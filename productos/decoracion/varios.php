                 ...
                 <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                     <div class="carousel-inner carrusel-principal mb-5">
                         <div class="carousel-item active">
                             <img src="../../img/portada-varios.png" class="d-block w-100 img-carrusel" style="width: 800px; height: auto;" alt="...">
                         </div>
                     </div>
                 </div>
             <!-- FINAL FOTO -->
                     ...
                     <div class="row">
                         <div class="col-12 ps-lg-5 ">
                             <div class="caja-texto-productos">
                                 <h2>🔮 Decoración Esotérica</h2>
                                 <p class="mt-lg-2 texto1-productos">Descubre la magia de nuestra decoración esotérica, donde cada elemento lleva consigo un significado profundo y una energía única. </p>
                                 <p class="mt-lg-2 texto2-productos">Embellece tu entorno con símbolos ancestrales y artefactos místicos que te conectan con lo divino y lo sagrado.</p>
                                 <p class="mt-lg-2 texto-3"> <strong>¡Explora nuestra colección y deja que la magia esotérica transforme tu espacio en un santuario de espiritualidad y armonía! ✨ </strong> </p>	
                             </div>
                 ...
                 <div class="container">
                     ...
                     <div class="row  d-flex flex-row ">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="calderoarboldelavida.php">
                                 <img src="../../img/decoracion-caldero-arboldelavida.jpeg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Caldero de Hierro Fundido - Árbol de la vida</h6>
                             <p class="precio">20,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="calderopentagrama.php">
                                 <img src="../../img/decoracion-caldero-estrella.jpeg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Caldero de Hierro Fundido - Pentagrama</h6>
                             <p class="precio">20,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="lamparasalhimalaya.php">
                                 <img src="../../img/decoracion-lampara-salhimalaya.png"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Lámpara de Sal del Himalaya</h6>
                             <p class="precio">12,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="lamparasalhimalayaluna.php">
                                 <img src="../../img/decoracion-lampara-luna-salhimalaya.png"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Lámpara de Sal del Himalaya Luna</h6>
                     ...
                     <div class="row  d-flex flex-row mt-2">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="lamparacatedralselenita.php">
                                 <img src="../../img/decoracion-lampara-selenita25.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Lámpara Catedral de Selenita</h6>
                             <p class="precio">45,00€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="fuenteelefantes.php">
                                 <img src="../../img/decoracion-fuente-elefante.png"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Fuente de agua interior - Familia Elefantes</h6>
                             <p class="precio">41,80€ </p>
                         </div>

                        
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="fuenteolas.php">
                                 <img src="../../img/decoracion-fuente-relajante.jpeg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Fuente de agua interior - Relajantes Olas Vertedoras</h6>
                             <p class="precio">41,80€ </p>
                         </div>

                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            <a href="arboldelavidaamatista.php">
                                <img src="../../img/decoracion-arboldelavida-amatista.png"  alt="" class="imagenescategorias">
                            </a>
                            <h6 class="texto-productos mt-2">Árbol de la Vida de Amatista</h6>
                            <p class="precio">61,50€ </p>
                        </div>
