...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=50";
        ...
        $precio = "SELECT precio FROM productos WHERE id=50";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=50";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=50";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=50";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=90";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=91";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO CON 
            $imagen3 = "SELECT ruta FROM imagenes WHERE id=92";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=50";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=50";
...
<head>
    ...
    <title>Místico - Altar Madera Rosa</title>
</head>
<body>
