...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=60";
        ...
        $precio = "SELECT precio FROM productos WHERE id=60";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=60";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=60";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=60";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=108";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=60";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=60";
...
<head>
    ...
    <title>Místico - Vela Petrichor</title>
</head>
<body>
