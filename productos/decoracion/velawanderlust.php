...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=61";
        ...
        $precio = "SELECT precio FROM productos WHERE id=61";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=61";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=61";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=61";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=109";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=61";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=61";
...
<head>
    ...
    <title>Místico - Vela Wanderlust</title>
</head>
<body>
