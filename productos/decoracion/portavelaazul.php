...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=66";
        ...
        $precio = "SELECT precio FROM productos WHERE id=66";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=66";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=66";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=66";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=114";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=66";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=66";
...
<head>
    ...
    <title>Místico - Portavela Azul</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Portavelas Gato</h5>
                        <p>10,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Portavelas Sal Rosa del Himalaya</h5>
                        <p>6,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Portavelas cilíndrico de Selenita en bruto</h5>
                        <p>8,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Portavelas cubo Selenita</h5>
                        <p>12,00€</p>
                    </div>
