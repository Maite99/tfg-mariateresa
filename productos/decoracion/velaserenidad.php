...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=57";
        ...
        $precio = "SELECT precio FROM productos WHERE id=57";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=57";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=57";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=57";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=103";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=57";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=57";
...
<head>
    ...
    <title>Místico - Vela Serenidad</title>
</head>
<body>
