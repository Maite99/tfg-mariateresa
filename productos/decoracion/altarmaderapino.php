...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=47";
        ...
        $precio = "SELECT precio FROM productos WHERE id=47";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=47";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=47";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=47";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=82";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=83";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO CON 
            $imagen3 = "SELECT ruta FROM imagenes WHERE id=84";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=47";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=47";
...
<head>
    ...
    <title>Místico - Altar Madera Pino 58x58</title>
</head>
<body>
