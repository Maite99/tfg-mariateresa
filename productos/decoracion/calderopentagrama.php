...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=72";
        ...
        $precio = "SELECT precio FROM productos WHERE id=72";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=72";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=72";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=72";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=120";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=72";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=72";
...
<head>
    ...
    <title>Místico - Caldero Pentagrama</title>
</head>
<body>
