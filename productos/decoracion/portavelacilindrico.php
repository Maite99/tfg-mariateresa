...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=69";
        ...
        $precio = "SELECT precio FROM productos WHERE id=69";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=69";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=69";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=69";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=117";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=69";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=69";
...
<head>
    ...
    <title>Místico - Portavela Cilíndrico Selenita</title>
</head>
<body>
