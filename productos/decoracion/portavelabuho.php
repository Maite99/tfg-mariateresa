...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=63";
        ...
        $precio = "SELECT precio FROM productos WHERE id=63";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=63";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=63";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=63";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=111";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=63";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=63";
...
<head>
    ...
    <title>Místico - Portavela Buho</title>
</head>
<body>
