...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=54";
        ...
        $precio = "SELECT precio FROM productos WHERE id=54";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=54";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=54";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=54";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=99";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=100";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=54";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=54";
...
<head>
    ...
    <title>Místico - Altar Meditación</title>
</head>
<body>
