...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=59";
        ...
        $precio = "SELECT precio FROM productos WHERE id=59";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=59";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=59";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=59";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=106";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO 
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=107";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=59";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=59";
...
<head>
    ...
    <title>Místico - Vela Algodón</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Vela Barefoot - Rosa e Ylang Ylang</h5>
                        <p>21,80€</p>
                    </div>
