...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=62";
        ...
        $precio = "SELECT precio FROM productos WHERE id=62";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=62";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=62";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=62";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=110";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=62";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=62";
...
<head>
    ...
    <title>Místico - Vela Barefoot</title>
</head>
<body>
