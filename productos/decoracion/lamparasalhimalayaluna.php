...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=74";
        ...
        $precio = "SELECT precio FROM productos WHERE id=74";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=74";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=74";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=74";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=122";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=74";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=74";
...
<head>
    ...
    <title>Místico - Lámpara Sal del Himalaya Luna</title>
</head>
<body>
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="arboldelavidaamatista.php">
                            <img src="../../img/decoracion-arboldelavida-amatista.png
"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Árbol de la Vida de Amatista</h5>
                        <p>61,50€</p>
                    </div>
