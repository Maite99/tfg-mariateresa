...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=56";
        ...
        $precio = "SELECT precio FROM productos WHERE id=56";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=56";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=56";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=56";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=201";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=56";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=56";
...
<head>
    ...
    <title>Místico - Vela Prosperidad</title>
</head>
<body>
