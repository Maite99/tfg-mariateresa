...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=67";
        ...
        $precio = "SELECT precio FROM productos WHERE id=67";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=67";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=67";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=67";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=115";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=67";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=67";
...
<head>
    ...
    <title>Místico - Portavela Gato</title>
</head>
<body>
