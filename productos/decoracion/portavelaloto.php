...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=65";
        ...
        $precio = "SELECT precio FROM productos WHERE id=65";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=65";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=65";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=65";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=113";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=65";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=65";
...
<head>
    ...
    <title>Místico - Portavela Loto</title>
</head>
<body>
