...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=64";
        ...
        $precio = "SELECT precio FROM productos WHERE id=64";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=64";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=64";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=64";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=112";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=64";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=64";
...
<head>
    ...
    <title>Místico - Portavela Dragonfly</title>
</head>
<body>
