...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=55";
        ...
        $precio = "SELECT precio FROM productos WHERE id=55";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=55";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=55";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=55";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=101";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=55";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=55";
...
<head>
    ...
    <title>Místico - Vela Protección</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Vela Serenidad - Manzana y madera</h5>
                        <p>15,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Vela de Soja con Punta de Cuarzo en Bruto - Palo Santo</h5>
                        <p>14,00€</p>
                    </div>
