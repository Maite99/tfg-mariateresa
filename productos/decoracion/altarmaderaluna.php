...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=52";
        ...
        $precio = "SELECT precio FROM productos WHERE id=52";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=52";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=52";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=52";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=96";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=97";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO CON 
            $imagen3 = "SELECT ruta FROM imagenes WHERE id=98";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=52";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=52";
...
<head>
    ...
    <title>Místico - Altar Fases Lunares </title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Altar Triangular de Madera de Pino 58x58</h5>
                        <p>82,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Altar Meditación Triangular de Madera 41x41x6</h5>
                        <p>55,50€</p>
                    </div>
