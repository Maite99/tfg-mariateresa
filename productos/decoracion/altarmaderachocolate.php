...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=46";
        ...
        $precio = "SELECT precio FROM productos WHERE id=46";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=46";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=46";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=46";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=79";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=80";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO CON 
            $imagen3 = "SELECT ruta FROM imagenes WHERE id=81";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=46";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=46";
...
<head>
    ...
    <title>Místico - Altar Chocolate 58x58</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Altar Triangular de Madera de Pino 31x31</h5>
                        <p>45,50€</p>
                    </div>
