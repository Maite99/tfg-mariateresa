...
<head>
    ...
    <title>Místico - Portavelas</title>
</head>
<body>
                 ...
                 <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                     <div class="carousel-inner carrusel-principal mb-5">
                         <div class="carousel-item active">
                             <img src="../../img/portada-portavelas.png" class="d-block w-100 img-carrusel" style="width: 800px; height: auto;" alt="...">
                         </div>
                     </div>
                 </div>
             <!-- FINAL FOTO -->
                     ...
                     <div class="row">
                         <div class="col-12 ps-lg-5 ">
                             <div class="caja-texto-productos">
                                 <h2>🔮 Encanto en Portavelas</h2>
                                 <p class="mt-lg-2 texto1-productos">Descubre la magia de nuestros portavelas, que transforman cualquier espacio con su luz y belleza.</p>
                                 <p class="mt-lg-2 texto2-productos">Embellece tu hogar con estos detalles encantadores y deja que su brillo te guíe hacia la tranquilidad.</p>
                                 <p class="mt-lg-2 texto-3"> <strong>¡Explora nuestra colección y enciende la magia en cada rincón! ✨ </strong> </p>	
                             </div>
                 ...
                 <div class="container">
                     ...
                     <div class="row  d-flex flex-row ">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portavelabuho.php">
                                 <img src="../../img/portavelas-buho-blanco.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Portavelas Búho</h6>
                             <p class="precio">8,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portaveladragonfly.php">
                                 <img src="../../img/portavelas-mariposas-blanco.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Portavelas Dragonfly</h6>
                             <p class="precio">8,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portavelaloto.php">
                                 <img src="../../img/portavelas-loto-blanco.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Portavelas Loto</h6>
                             <p class="precio">8,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portavelaazul.php">
                                 <img src="../../img/portavela-azul.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Portavelas Azul</h6>
                     ...
                     <div class="row  d-flex flex-row mt-2">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portavelagato.php">
                                 <img src="../../img/portavelas-gatito.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Portavelas Gato</h6>
                             <p class="precio">10,00€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portavelasalrosa.php">
                                 <img src="../../img/portavelas-salrosa.jpeg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Portavelas Sal Rosa del Himalaya</h6>
                             <p class="precio">6,00€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portavelacilindrico.php">
                                 <img src="../../img/portavelas-selenita.png"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Portavelas cilíndrico de Selenita en bruto</h6>
                             <p class="precio">12,00€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portavelacubo.php">
                                 <img src="../../img/portavelas-selenitacuadrado.png"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Portavelas cubo Selenita</h6>
                             <p class="precio">12,00€ </p>
                         </div>
