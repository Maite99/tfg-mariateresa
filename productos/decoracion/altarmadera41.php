...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=49";
        ...
        $precio = "SELECT precio FROM productos WHERE id=49";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=49";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=49";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=49";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=88";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=89";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=49";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=49";
...
<head>
    ...
    <title>Místico - Altar Madera 41x41x6</title>
</head>
<body>
