                 ...
                 <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                     <div class="carousel-inner carrusel-principal mb-5">
                         <div class="carousel-item active">
                             <img src="../../img/portada-altares.png" class="d-block w-100 img-carrusel" style="width: 800px; height: auto;" alt="...">
                         </div>
                     </div>
                 </div>
             <!-- FINAL FOTO -->
                     ...
                     <div class="row">
                         <div class="col-12 ps-lg-5 ">
                             <div class="caja-texto-productos">
                                 <h2>🔮 Altares de Encanto</h2>
                                 <p class="mt-lg-2 texto1-productos">Descubre la magia de nuestros altares, espacios de paz y conexión donde la espiritualidad se une con la belleza. Cada elemento emana serenidad y eleva el alma.</p>
                                 <p class="mt-lg-2 texto2-productos">Embellece tu hogar con nuestra colección, recordándote la importancia de la práctica espiritual en tu vida diaria.</p>
                                 <p class="mt-lg-2 texto-3"> <strong>¡Explora ahora y transforma tu espacio en un santuario de tranquilidad! ✨ </strong> </p>	
                             </div>
                 ...
                 <div class="container">
                     ...
                     <div class="row  d-flex flex-row ">
                        <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            <a href="altarmaderachocolate.php">
                                <img src="../../img/altar-triangular-chocolate.jpeg"  alt="" class="imagenescategorias">
                            </a>
                            <h6 class="texto-productos mt-2">Altar Triangular de Madera Chocolate 58x58</h6>
                            <p class="precio">82,50€ </p>
                        </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="altarmaderapino.php">
                                 <img src="../../img/altar-triangular-pino.jpeg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Altar Triangular de Madera de Pino 58x58</h6>
                             <p class="precio">82,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="altarmaderapino31.php">
                                 <img src="../../img/altar-triangular-pino31.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Altar Triangular de Madera de Pino 31x31</h6>
                         ...
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            ...
                            <h6 class="texto-productos mt-2">Altar Triangular de Madera 41x41x6</h6>
                     ...
                     <div class="row  d-flex flex-row mt-2">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             ...
                             <h6 class="texto-productos mt-2">Altar Triangular de Madera Rosa 31x31</h6>
                             <p class="precio">45,50€ </p>
                         </div>
                         ...
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             ...
                             <h6 class="texto-productos mt-2">Altar Triangular de Madera Azul 31x31</h6>
                             <p class="precio">45,50€</p>
                         </div>
                         ...
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             ...
                             <h6 class="texto-productos mt-2">Altar Triangular de Madera con Fases Lunares 31x31</h6>
                             <p class="precio">45,50€ </p>
                         </div>
                         ...
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="altarmeditacion.php">
                                 <img src="../../img/altar-meditacion-madera.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Altar Meditación Triangular de Madera 41x41x6</h6>
                             <p class="precio">55,50€ </p>
                         </div>
                     </div>
                 </div>
