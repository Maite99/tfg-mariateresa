...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=68";
        ...
        $precio = "SELECT precio FROM productos WHERE id=68";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=68";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=68";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=68";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=116";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=68";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=68";
...
<head>
    ...
    <title>Místico - Portavela Sal Rosa</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Portavelas Dragonfly</h5>
                        <p>8,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Portavelas Loto</h5>
                        <p>8,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Portavelas Azul</h5>
                        <p>11,50€</p>
                    </div>
