...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=70";
        ...
        $precio = "SELECT precio FROM productos WHERE id=70";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=70";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=70";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=70";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=118";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=70";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=70";
...
<head>
    ...
    <title>Místico - Portavela Cubo Selenita</title>
</head>
<body>
