...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=73";
        ...
        $precio = "SELECT precio FROM productos WHERE id=73";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=73";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=73";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=73";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=121";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=73";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=73";
...
<head>
    ...
    <title>Místico -  Lámpara Sal del Himalaya</title>
</head>
<body>
