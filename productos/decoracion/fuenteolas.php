...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=77";
        ...
        $precio = "SELECT precio FROM productos WHERE id=77";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=77";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=77";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=77";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=125";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=77";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=77";
...
<head>
    ...
    <title>Místico - Fuente Interior Olas</title>
</head>
<body>
