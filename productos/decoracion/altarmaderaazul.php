...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=51";
        ...
        $precio = "SELECT precio FROM productos WHERE id=51";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=51";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=51";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=51";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=93";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=94";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO CON 
            $imagen3 = "SELECT ruta FROM imagenes WHERE id=95";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=51";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=51";
...
<head>
    ...
    <title>Místico - Altar Madera Azul</title>
</head>
<body>
