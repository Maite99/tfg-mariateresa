...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=58";
        ...
        $precio = "SELECT precio FROM productos WHERE id=58";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=58";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=58";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=58";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=104";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO 
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=105";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=58";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=58";
...
<head>
    ...
    <title>Místico - Vela Palo Santo</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Vela Prosperidad - Naranja especiada</h5>
                        <p>12,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Vela de Soja con Punta de Cuarzo en Bruto - Algodón</h5>
                        <p>14,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Vela Petrichor - Lluvia y Tierra</h5>
                        <p>21,80€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Vela Wanderlust - Granada y Bosque</h5>
                        <p>21,80€</p>
                    </div>
