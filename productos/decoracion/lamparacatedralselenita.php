...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=75";
        ...
        $precio = "SELECT precio FROM productos WHERE id=75";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=75";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=75";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=75";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=123";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=75";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=75";
...
<head>
    ...
    <title>Místico - Lámpara Catedral Selenita</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Lámpara de Sal del Himalaya</h5>
                        <p>12,50€</p>
                    </div>
...
"  alt="" class="imagenescategorias">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Fuente de agua interior - Familia Elefantes</h5>
                        <p>41,80€</p>
                    </div>
