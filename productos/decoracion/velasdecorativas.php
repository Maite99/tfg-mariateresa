                     ...
                     <div class="row">
                         <div class="col-12 ps-lg-5 ">
                             <div class="caja-texto-productos">
                                 <h2>🔮 Magia en Vela</h2>
                                 <p class="mt-lg-2 texto1-productos">Descubre nuestra colección de velas, que llenan tu hogar con luz y calidez, creando una atmósfera de serenidad y paz.</p>
                                 <p class="mt-lg-2 texto2-productos">Embellece tu espacio y deja que su suave resplandor te guíe en momentos de tranquilidad.</p>
                                 <p class="mt-lg-2 texto-3"> <strong>¡Explora ahora y enciende la magia en tu vida! ✨ </strong> </p>	
                             </div>
                 ...
                 <div class="container">
                     ...
                     <div class="row  d-flex flex-row ">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             ...
                             <h6 class="texto-productos mt-2">Vela Protección - Canela y limón</h6>
                     ...
                     <div class="row  d-flex flex-row mt-2">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             ...
                             <h6 class="texto-productos mt-2">Vela de Soja con Punta de Cuarzo en Bruto - Algodón</h6>
                             <p class="precio">14,00€ </p>
                         </div>
