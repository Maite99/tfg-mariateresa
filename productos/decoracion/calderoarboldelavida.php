...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=71";
        ...
        $precio = "SELECT precio FROM productos WHERE id=71";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=71";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=71";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=71";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=119";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=71";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=71";
...
<head>
    ...
    <title>Místico - Caldero Árbol de la Vida </title>
</head>
<body>
