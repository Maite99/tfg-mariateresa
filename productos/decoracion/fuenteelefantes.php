...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=76";
        ...
        $precio = "SELECT precio FROM productos WHERE id=76";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=76";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=76";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=76";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=124";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=76";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=76";
...
<head>
    ...
    <title>Místico - Fuente Interior Elefantes</title>
</head>
<body>
