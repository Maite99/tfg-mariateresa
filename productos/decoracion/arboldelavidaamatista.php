...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=78";
        ...
        $precio = "SELECT precio FROM productos WHERE id=78";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=78";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=78";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=78";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=126";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=78";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=78";
...
<head>
    ...
    <title>Místico - Árbol de la vida de Amatista</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Caldero de Hierro Fundido - Pentagrama</h5>
                        <p>20,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Fuente de agua interior - Relajantes Olas Vertedoras</h5>
                        <p>41,80€</p>
                    </div>

                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="lamparasalhimalayaluna.php">
                            <img src="../../img/decoracion-lampara-luna-salhimalaya.png
"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Lámpara de Sal del Himalaya Luna</h5>
                        <p>15,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Lámpara Catedral de Selenita</h5>
                        <p>45,00€</p>
                    </div>
