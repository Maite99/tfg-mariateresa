...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=20";
        ...
        $precio = "SELECT precio FROM productos WHERE id=20";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=20";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=20";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=20";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=31";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=32";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=20";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=20";
...
<head>
    ...
    <title>Místico - Portaincienso Tokusa</title>
</head>
<body>
