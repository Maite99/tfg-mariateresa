...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=9";
        ...
        $precio = "SELECT precio FROM productos WHERE id=9";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=9";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=9";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=9";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=11";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO 
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=12";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=9";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=9";
...
<head>
    ...
    <title>Místico - Incienso Salvia Blanca</title>
</head>
<body>
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                  ...
                                  <div class="carousel-item ">
                                    <img src="<?php echo $imagen2 ?>" class="imagen-producto img-fluid" alt="Imagen 2">
                                  </div>
                                </div>
            ...
            <div class="row mt-3">
                <div class="col">
                    ...
                    <div class="tab-content">
                        ...
                        <?php echo $descripcion2_formateada ?>
                        </div>
                        <div class="tab-pane mt-4" id="tab2">
                        <?php echo $informacion_general_formateada ?>
                        </div>
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="inciensosalviablanca.php">
                            <img src="../../img/inciensogoloka-salviablanca.png"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Incienso Goloka - Salvia Blanca</h5>
                        <p>1,80€</p>
                    </div>
                    ...
                    <div class="categoria-velas col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="inciensofragipani.php">
                            <img src="../../img/inciensogoloka-nagchampa.jpg"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Incienso Goloka - Nag Champa</h5>
                        <p>1,80€</p>
                    </div>
