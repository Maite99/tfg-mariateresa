...
<head>
    ...
    <title>Místico - Portainciensos y Quemadores</title>
</head>
<body>
                 ...
                 <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                     <div class="carousel-inner carrusel-principal mb-5">
                         <div class="carousel-item active">
                             <img src="../../img/portainciensos-portada.png" class="d-block w-100 img-carrusel" style="width: 800px; height: auto;" alt="...">
                         </div>
                     </div>
                 </div>
             <!-- FINAL FOTO -->
                     ...
                     <div class="row">
                         <div class="col-12 ps-lg-5 ">
                             <div class="caja-texto-productos">
                                 <h2>🔮 Descubre la Magia de los Portainciensos</h2>
                                 <p class="mt-lg-2 texto1-productos">Adéntrate en el mundo encantado de nuestros portainciensos, objetos que no solo son funcionales, sino que también son portadores de una atmósfera de armonía y serenidad. Colócalos en tu espacio sagrado y déjate llevar por la magia que desprenden.</p>
                                 <p class="mt-lg-2 texto2-productos">Utilízalos durante tus meditaciones, en tus momentos de reflexión o simplemente para añadir un toque de paz a tu día a día.</p>
                                 <p class="mt-lg-2 texto-3"> <strong>¡Descubre la variedad de estilos y diseños ahora mismo y da la bienvenida a la magia a tu vida! 🌟 </strong> </p>	
                             </div>
                 ...
                 <div class="container">
                     ...
                     <div class="row  d-flex flex-row ">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portainciensoblanceebano.php">
                                 <img src="../../img/incensario-ebano.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Incensario Blance ébano</h6>
                             <p class="precio">12,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portainciensorubanclaro.php">
                                 <img src="../../img/incensario-rubanclaro.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Incensario Ruban claro</h6>
                             <p class="precio">12,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portainciensorubanebano.php">
                                 <img src="../../img/incensario-rubanebano.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Incensario Ruban ébano</h6>
                             <p class="precio">12,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portainciensopicoebano.php">
                                 <img src="../../img/incensario-picoebano.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Incensario Pico ébano</h6>
                             <p class="precio">12,50€ </p>
                         </div>
                     ...
                     <div class="row  d-flex flex-row mt-2">
                        ...
                        <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            <a href="portainciensoparamita.php">
                                <img src="../../img/incensario-paramitanegra.jpg"  alt="" class="imagenescategorias">
                            </a>
                            <h6 class="texto-productos mt-2">Incensario Paramita Negro</h6>
                            <p class="precio">15,00€ </p>
                        </div>

                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portainciensokuroi.php">
                                 <img src="../../img/incensario-kuroi.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Incensario Kuroi</h6>
                         ...
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portainciensoyukari.php">
                                 <img src="../../img/incensario-yukariplanoblanco.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Incensario Yukari Plano Blanco</h6>
                         ...
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="portainciensotokusa.php">
                                 <img src="../../img/incensario-tokusa.jpg"  alt="" class="imagenescategorias">
                             </a>
                             <h6 class="texto-productos mt-2">Incensario Tokusa</h6>
                             <p class="precio">10,50€ </p>
                         </div>
