...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=26";
        ...
        $precio = "SELECT precio FROM productos WHERE id=26";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=26";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=26";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=26";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=43";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=44";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=26";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=26";
...
<head>
    ...
    <title>Místico - Bombita Herbal Limpiar</title>
</head>
<body>
