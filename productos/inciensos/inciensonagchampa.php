...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=11";
        ...
        $precio = "SELECT precio FROM productos WHERE id=11";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=11";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=11";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=11";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=13";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO 
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=14";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=11";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=11";
...
<head>
    ...
    <title>Místico - Incienso Nag Champa</title>
</head>
<body>
