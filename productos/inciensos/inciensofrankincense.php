...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=8";
        ...
        $precio = "SELECT precio FROM productos WHERE id=8";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=8";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=8";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=8";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=7";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO 
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=8";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=8";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=8";
...
<head>
    ...
    <title>Místico - Incienso Frankincense</title>
</head>
<body>
