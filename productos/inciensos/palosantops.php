...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=21";
        ...
        $precio = "SELECT precio FROM productos WHERE id=21";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=21";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=21";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=21";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=33";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=34";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=21";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=21";
...
<head>
    ...
    <title>Místico - Palo Santo </title>
</head>
<body>
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="palosanto7hierbas.php">
                            <img src="../../img/sahumerio-7hierbas.jpg"alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Sahumerio 7 hierbas Sabiduría</h5>
                        <p>5,50€</p>
                    </div>
