...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=19";
        ...
        $precio = "SELECT precio FROM productos WHERE id=19";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=19";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=19";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=19";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=29";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=30";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=19";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=19";
...
<head>
    ...
    <title>Místico -  Portaincienso Yukari</title>
</head>
<body>
