...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=23";
        ...
        $precio = "SELECT precio FROM productos WHERE id=23";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=23";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=23";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=23";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=37";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=38";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=23";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=23";
...
<head>
    ...
    <title>Místico - Sahumerio 7 hierbas Sabiduría</title>
</head>
<body>
