...
session_start();
        ...
        // SENTENCIA PARA OBTENER EL TITULO (NOMBRE) DEL PRODUCTO CON id=5
        $titulo = "SELECT nombre FROM productos WHERE id=5";
        ...
        $precio = "SELECT precio FROM productos WHERE id=5";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=5";
        ...
        // SENTENCIA PARA OBTENER LA SEGUNDA DESCRIPCION DEL PRODUCTO CON id=5
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=5";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO CON id=5
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=5";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=3";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO CON 
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=4";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=5";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=5";
...
<head>
    ...
    <title>Místico - Incienso Jazmine</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="inciensolavanda.php">
                            <img src="../../img/inciensoorganic-lavanda.jpeg"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Incienso Organic - Lavanda</h5>
                        <p>2,50€</p>
                    </div>
