...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=16";
        ...
        $precio = "SELECT precio FROM productos WHERE id=16";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=16";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=16";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=16";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=23";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=24";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=16";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=16";
...
<head>
    ...
    <title>Místico - Portaincienso Pico Ébano</title>
</head>
<body>
