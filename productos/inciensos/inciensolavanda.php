...
session_start();
        ...
        // SENTENCIA PARA OBTENER EL TITULO (NOMBRE) DEL PRODUCTO CON id=4
        $titulo = "SELECT nombre FROM productos WHERE id=4";
        ...
        // SENTENCIA PARA OBTENER EL PRECIO DEL PRODUCTO CON id=4
        $precio = "SELECT precio FROM productos WHERE id=4";
        ...
        // SENTENCIA PARA OBTENER LA DESCRIPCIÓN DEL PRODUCTO CON id=4
        $descripcion = "SELECT descripcion FROM productos WHERE id=4";
        ...
        // SENTENCIA PARA OBTENER LA SEGUNDA DESCRIPCION DEL PRODUCTO CON id=4
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=4";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO CON id=4
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=4";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO CON id=4
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=1";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO CON id=4
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=2";
            ...
            // SENTENCIA PARA OBTENER EL ID DEL PRODUCTO DEL PRODUCTO CON id=4
            $producto_id = "SELECT id FROM productos WHERE id=4";
            ...
            // ESTABLECER LA QUERY PARA EL ID DEL PRODUCTO
                ...
                // SENTENCIA PARA OBTENER LA CANTIDAD DE STOCK DEL PRODUCTO CON id=4
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=4";
...
<head>
    ...
    <title>Místico - Incienso Lavanda</title>
</head>
<body>
                            ...
                            <ul class="navbar-nav ms-auto"> 
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item a-navbar" href="../../productos/rodados.php">Rodados</a></li>
                                    </ul>
                                </li>
                                <!-- DECORACIÓN -->
                                <li class="nav-item dropdown">
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                  ...
                                  <img src="<?php echo $imagen1 ?>" class="imagen-producto img-fluid" alt="Imagen 1" >
                                    ...
                                    <!-- <img src="../../img/inciensoorganic-lavanda.jpeg" class="imagen-producto img-fluid" alt="Imagen 1"> -->
                                  </div>
                                  <div class="carousel-item ">
                                  <img src="<?php echo $imagen2 ?>" class="imagen-producto img-fluid" alt="Imagen 1" >
                                    <!-- <img src="../../img/inciensoorganic-lavanda2.jpeg.png" class="imagen-producto img-fluid" alt="Imagen 2"> -->
                                  </div>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="inciensojazmine.php">
                            <img src="../../img/inciensoorganic-jazmine.jpeg"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Incienso Organic - Jazmine</h5>
                        <p>2,50€</p>
                    </div>
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="inciensodragonsblood.php">
                            <img src="../../img/inciensoorganic-dragonsblood.jpeg"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Incienso Organic - Dragon's blood</h5>
                        <p>2,50€</p>
                    </div>

                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="inciensofrankincense.php">
                            <img src="../../img/inciensobanjara-frankincense.jpeg"alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Incienso Organic - Frankincense</h5>
                        <p>2,50€</p>
                    </div>

                    <div class="categoria-velas col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="inciensofragipani.php">
                            <img src="../../img/inciensogoloka-fragipani.jpeg"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Incienso Goloka - Fragipani</h5>
                        <p>1,60€</p>
                    </div>
