...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=12";
        ...
        $precio = "SELECT precio FROM productos WHERE id=12";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=12";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=12";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=12";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=15";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO 
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=16";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=12";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=12";
...
<head>
    ...
    <title>Místico - Incienso Palo Santo</title>
</head>
<body>
