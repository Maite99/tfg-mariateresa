...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=18";
        ...
        $precio = "SELECT precio FROM productos WHERE id=18";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=18";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=18";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=18";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=27";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=28";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=18";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=18";
...
<head>
    ...
    <title>Místico - Incensario Kuroi</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Incensario Tokusa</h5>
                        <p>10,50€</p>
                    </div>
