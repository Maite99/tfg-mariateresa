...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=22";
        ...
        $precio = "SELECT precio FROM productos WHERE id=22";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=22";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=22";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=22";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=35";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=36";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=22";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=22";
...
<head>
    ...
    <title>Místico - Sahumerio Salvia Blanca</title>
</head>
<body>
