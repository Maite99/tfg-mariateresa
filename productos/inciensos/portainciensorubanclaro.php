...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=14";
        ...
        $precio = "SELECT precio FROM productos WHERE id=14";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=14";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=14";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=14";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=19";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=20";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=14";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=14";
...
<head>
    ...
    <title>Místico - Portaincienso Ruban Claro</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-velas col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Incensario Kuroi</h5>
                        <p>10,50€</p>
                    </div>
