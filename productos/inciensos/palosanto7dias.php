...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=24";
        ...
        $precio = "SELECT precio FROM productos WHERE id=24";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=24";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=24";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=24";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=39";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=40";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=24";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=24";
...
<head>
    ...
    <title>Místico - Sahumerio 7 días de Limpieza</title>
</head>
<body>
