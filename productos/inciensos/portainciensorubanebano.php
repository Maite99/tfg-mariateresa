...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=15";
        ...
        $precio = "SELECT precio FROM productos WHERE id=15";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=15";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=15";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=15";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=21";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=22";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=15";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=15";
...
<head>
    ...
    <title>Místico -  Portaincienso Ruban Ébano</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Incensario Yukari Plano Blanco</h5>
                        <p>14,50€</p>
                    </div>
