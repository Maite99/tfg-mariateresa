                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner carrusel-principal mb-5">
                        <div class="carousel-item active">
                            <img src="../../img/portada-incienso.jpg" class="d-block w-100 img-carrusel" style="width: 800px; height: auto;" alt="...">
                        </div>
                    </div>
                </div>
            <!-- FINAL FOTO -->
            		...
            		<div class="row  d-flex flex-row ">
            			<div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            <a href="inciensolavanda.php">
                                <img src="../../img/inciensoorganic-lavanda.jpeg"  alt="" class="imagenesproductos">
                            </a>
                            <h6 class="texto-productos mt-2">Incienso Organic - Lavanda</h6>
                            <p class="precio">2,50€ </p>
            			</div>

                        <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            <a href="inciensojazmine.php">
                                <img src="../../img/inciensoorganic-jazmine.jpeg"  alt="" class="imagenesproductos">
                            </a>
                            <h6 class="texto-productos mt-2">Incienso Organic - Jazmine</h6>
                            <p class="precio">2,50€ </p>
            			</div>

                        <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            <a href="inciensodragonsblood.php">
                                <img src="../../img/inciensoorganic-dragonsblood.jpeg"  alt="" class="imagenesproductos">
                            </a>
                            <h6 class="texto-productos mt-2">Incienso Organic - Dragon's blood</h6>
                            <p class="precio">2,50€ </p>
            			</div>

                        <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            <a href="inciensofrankincense.php">
                                <img src="../../img/inciensoorganic-goodness.jpg"  alt="" class="imagenesproductos">
                            </a>
                            <h6 class="texto-productos mt-2">Incienso Organic - Frankincense</h6>
                            <p class="precio">2,50€ </p>
            			</div>
            		...
            		<div class="row  d-flex flex-row mt-2">
                        <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            <a href="inciensofragipani.php">
                                <img src="../../img/inciensogoloka-fragipani.jpeg"  alt="" class="imagenesproductos">
                            </a>
                            <h6 class="texto-productos mt-2">Incienso Goloka - Fragipani</h6>
                            <p class="precio">1,60€ </p>
            			</div>

            			<div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            <a href="inciensosalviablanca.php">
                                <img src="../../img/inciensogoloka-salviablanca.png"  alt="" class="imagenesproductos">
                            </a>
                            <h6 class="texto-productos mt-2">Incienso Goloka - Salvia Blanca</h6>
                            <p class="precio">1,80€ </p>
            			</div>

                        <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            <a href="inciensonagchampa.php">
                                <img src="../../img/inciensogoloka-nagchampa.jpg"  alt="" class="imagenesproductos">
                            </a>
                            <h6 class="texto-productos mt-2">Incienso Goloka - Nag Champa</h6>
                            <p class="precio">1,80€ </p>
            			</div>
                        ...
                        <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                            <a href="inciensopalosanto.php">
                                <img src="../../img/incienso-palosanto.png"  alt="" class="imagenesproductos">
                            </a>
                            <h6 class="texto-productos mt-2">Incienso GR - Palo Santo</h6>
                            <p class="precio">1,60€ </p>
            			</div>
