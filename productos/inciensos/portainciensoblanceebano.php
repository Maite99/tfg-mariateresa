...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=13";
        ...
        $precio = "SELECT precio FROM productos WHERE id=13";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=13";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=13";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=13";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=17";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=18";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=13";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=13";
...
<head>
    ...
    <title>Místico - Portaincienso Blanco Ébano</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-velas col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Incensario Ruban Claro</h5>
                        <p>12,50€</p>
                    </div>
                    ...
                    <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Incensario Ruban ébano</h5>
                        <p>12,50€</p>
                    </div>
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Incensario Pico ébano</h5>
                        <p>12,50€</p>
                    </div>
                    ...
                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Incensario Paramita Negro</h5>
                        <p>15,00€</p>
                    </div>
