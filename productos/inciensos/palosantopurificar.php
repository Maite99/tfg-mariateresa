...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=27";
        ...
        $precio = "SELECT precio FROM productos WHERE id=27";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=27";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=27";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=27";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=45";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=46";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=27";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=27";
...
<head>
    ...
    <title>Místico - Bombita Herbal Purificar</title>
</head>
<body>
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="palosantoamor.php">
                            <img src="../../img/bombita-amor.jpg"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Bombita Herbal Amor x4</h5>
                        <p>3,65€</p>
                    </div>
