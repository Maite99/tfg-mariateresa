...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=10";
        ...
        $precio = "SELECT precio FROM productos WHERE id=10";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=10";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=10";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=10";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=9";
            ...
            // SENTENCIA PARA OBTENER LA IMAGEN DEL PRODUCTO 
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=10";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=10";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=10";
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="inciensopalosanto.php">
                            <img src="../../img/incienso-palosanto.png"alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Incienso GR - Palo Santo</h5>
                        <p>1,60€</p>
                    </div>
