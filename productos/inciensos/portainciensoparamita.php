...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=17";
        ...
        $precio = "SELECT precio FROM productos WHERE id=17";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=17";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=17";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=17";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=25";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=26";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=17";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=17";
...
<head>
    ...
    <title>Místico - Incensario Paramita Negra</title>
</head>
<body>
