...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=28";
        ...
        $precio = "SELECT precio FROM productos WHERE id=28";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=28";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=28";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=28";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=47";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=48";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=28";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=28";
...
<head>
    ...
    <title>Místico - Bombita Herbal Renacer</title>
</head>
<body>
