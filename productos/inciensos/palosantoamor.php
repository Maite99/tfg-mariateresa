...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=25";
        ...
        $precio = "SELECT precio FROM productos WHERE id=25";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=25";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=25";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=25";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=41";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=42";
...
<head>
    ...
    <title>Místico - Bombita Herbal Amor</title>
</head>
<body>
                ...
                <div class="col">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active mt-4" id="tab1">
                            <p><strong>Elaboración: </strong> Incienso Artesanal. Hecho a mano. Vegano. </p>
                            <p><strong>Composición: </strong>Pétalos de rosas, ruda, laurel, eucalipto, cedro y aglutinante natural.</p>
                            <p><strong>Contenido: </strong>4 bombitas herbales de pétalos de rosa, ruda, laurel, eucalipto y cedro.</p>
                            <p><strong>Tiempo de quemado: </strong> Cada bombita tiene una duración de 10 minutos.</p>
                            <p><strong>Modo de empleo: </strong> 1. Colocar la defumación activada en un recipiente no inflamable. 2. Encender con una vela. 3. Hacer la limpieza en un ambiente ventilado. 4. Tirar los restos a la tierra.</p>
                            <p><strong>Usos: </strong>Limpieza y protección de espacios, sanación y armonización.</p>
                         </div>
                        
                        <div class="tab-pane mt-4" id="tab2">
                            <p><strong>Peso: </strong>	0,52 kg</p>
                            <p><strong>Aroma: </strong>	7 Elementos, 7 Hierbas y Copal, Incienso y Mirra, Limpieza energética, Palo Santo, Yagra y Canela</p>
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="palosantosalviablanca.php">
                            <img src="../../img/sahumerio-salviablanca.jpeg"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Sahumerio de Salvia Blanca</h5>
                        <p>4,80€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Bombita Herbal Limpiar x4</h5>
                        <p>3,65€</p>
                    </div>
                    ...
                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Bombita Herbal Purificar x4</h5>
                        <p>3,65€</p>
                    </div>
                    ...
                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="palosantorenacer.php">
                            <img src="../../img/bombita-renacer.jpg"alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Bombita Herbal Renacer x4</h5>
                        <p>3,65€</p>
                    </div>
