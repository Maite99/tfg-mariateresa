...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=147";
        ...
        $precio = "SELECT precio FROM productos WHERE id=147";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=147";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=147";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=147";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=196";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=147";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=147";
...
<head>
    ...
    <title>Místico - Kit de Amor Propio</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Kit de regalo - "La magia está en creer en ti"</h5>
                        <p>30,60€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Kit de regalo - "Cuando sonríes haces magia"</h5>
                        <p>31,60€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Kit de regalo - Sahumerio Sagrado Armonía</h5>
                        <p>41,80€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Kit de regalo - Sahumerio Sagrado Limpieza y Protección</h5>
                        <p>34,90€</p>
                    </div>
