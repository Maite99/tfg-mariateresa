...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=149";
        ...
        $precio = "SELECT precio FROM productos WHERE id=149";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=149";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=149";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=149";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=198";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=149";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=149";
...
<head>
    ...
    <title>Místico - Kit Sonreir</title>
</head>
<body>
