...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=151";
        ...
        $precio = "SELECT precio FROM productos WHERE id=151";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=151";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=151";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=151";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=200";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=151";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=151";
...
<head>
    ...
    <title>Místico - Kit Limpieza y Protección</title>
</head>
<body>
