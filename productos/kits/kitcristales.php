...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=145";
        ...
        $precio = "SELECT precio FROM productos WHERE id=145";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=145";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=145";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=145";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=194";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=145";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=145";
...
<head>
    ...
    <title>Místico - Kit Cristales</title>
</head>
<body>
