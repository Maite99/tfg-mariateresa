...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=120";
        ...
        $precio = "SELECT precio FROM productos WHERE id=120";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=120";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=120";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=120";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=169";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=120";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=120";
...
<head>
    ...
    <title>Místico - Oráculo Sabiduría de Bruja</title>
</head>
<body>
