...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=139";
        ...
        $precio = "SELECT precio FROM productos WHERE id=139";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=139";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=139";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=139";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=188";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=139";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=139";
...
<head>
    ...
    <title>Místico - Velón Rosa para Atraer</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Velón amarillo para Entrada de Dinero</h5>
                        <p>8,50€</p>
                    </div>
