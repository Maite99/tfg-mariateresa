...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=121";
        ...
        $precio = "SELECT precio FROM productos WHERE id=121";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=121";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=121";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=121";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=170";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=121";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=121";
...
<head>
    ...
    <title>Místico - Oráculo Astrológico</title>
</head>
<body>
