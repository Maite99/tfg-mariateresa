...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=140";
        ...
        $precio = "SELECT precio FROM productos WHERE id=140";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=140";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=140";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=140";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=189";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=140";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=140";
...
<head>
    ...
    <title>Místico - Velón Amarillo para Entrada de Dinero</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Velón morado para Energía y Vitalidad</h5>
                        <p>8,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Velón azul para Salud y Sanación</h5>
                        <p>8,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Velón negro para Eliminar Maleficios</h5>
                        <p>8,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Velón rojo para Abrir Caminos</h5>
                        <p>8,50€</p>
                    </div>
