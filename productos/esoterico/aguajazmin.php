...
$titulo = "SELECT nombre FROM productos WHERE id=131";
...
$precio = "SELECT precio FROM productos WHERE id=131";
...
$descripcion = "SELECT descripcion FROM productos WHERE id=131";
...
$descripcion2 = "SELECT descripcion2 FROM productos WHERE id=131";
    ...
    // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
        $informacion_general = "SELECT informacion_general FROM productos WHERE id=131";
    ...
    $imagen1 = "SELECT ruta FROM imagenes WHERE id=180";
    ...
    $producto_id = "SELECT id FROM productos WHERE id=131";
    ...
    $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=131";
...
<head>
    ...
    <title>Místico - Agua de Jazmin</title>
</head>
<body>
