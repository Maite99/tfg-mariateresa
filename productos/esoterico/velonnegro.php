...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=143";
        ...
        $precio = "SELECT precio FROM productos WHERE id=143";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=143";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=143";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=143";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=192";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=143";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=143";
...
<head>
    ...
    <title>Místico - Velón Negro para Eliminar Maleficios</title>
</head>
<body>
