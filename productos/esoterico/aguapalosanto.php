...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=130";
        ...
        $precio = "SELECT precio FROM productos WHERE id=130";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=130";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=130";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=130";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=179";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=130";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=130";
...
<head>
    ...
    <title>Místico - Agua de Palo Santo</title>
</head>
<body>
