...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=132";
        ...
        $precio = "SELECT precio FROM productos WHERE id=132";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=132";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=132";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=132";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=181";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=132";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=132";
...
<head>
    ...
    <title>Místico - Agua de Ruda</title>
</head>
<body>
