...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=133";
        ...
        $precio = "SELECT precio FROM productos WHERE id=133";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=133";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=133";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=133";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=182";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=133";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=133";
...
<head>
    ...
    <title>Místico - Agua de Canela</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Agua de Luna</h5>
                        <p>9,50€</p>
                    </div>
