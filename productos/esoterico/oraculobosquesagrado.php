...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=122";
        ...
        $precio = "SELECT precio FROM productos WHERE id=122";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=122";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=122";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=122";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=171";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=122";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=122";
...
<head>
    ...
    <title>Místico - Oráculo del Bosque Sagrado</title>
</head>
<body>
