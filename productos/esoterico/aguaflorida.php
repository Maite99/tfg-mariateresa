...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=127";
        ...
        $precio = "SELECT precio FROM productos WHERE id=127";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=127";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=127";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=127";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=176";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=127";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=127";
...
<head>
    ...
    <title>Místico - Agua de Florida</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Agua de Kananga Murray & Lanman</h5>
                        <p>12,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Agua de rosas de Murray & Lanman</h5>
                        <p>9,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Agua de colonia “Palo Santo”</h5>
                        <p>9,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Agua de colonia de Jazmin</h5>
                        <p>9,50€</p>
                    </div>
