...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=126";
        ...
        $precio = "SELECT precio FROM productos WHERE id=126";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=126";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=126";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=126";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=175";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=126";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=126";
...
<head>
    ...
    <title>Místico - Oráculo Altamente Sensible</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">El Oráculo de la Energía y el Espíritu</h5>
                        <p>22,50€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Tarot del Horóscopo</h5>
                        <p>14,80€</p>
                    </div>
