...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=119";
        ...
        $precio = "SELECT precio FROM productos WHERE id=119";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=119";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=119";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=119";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=168";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=119";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=119";
...
<head>
    ...
    <title>Místico - Oráculo de la Energía y el Espíritu</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Tarot Sabiduría de Bruja</h5>
                        <p>34,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">El Oráculo Astrológico</h5>
                        <p>26,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">El Oráculo del Bosque Sagrado</h5>
                        <p>26,00€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">El Oráculo de las 7 Energías</h5>
                        <p>20,60€</p>
                    </div>
