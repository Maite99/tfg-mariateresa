...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=138";
        ...
        $precio = "SELECT precio FROM productos WHERE id=138";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=138";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=138";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=138";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=187";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=138";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=138";
...
<head>
    ...
    <title>Místico - Velón Blanco para Claridad Mental</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Velón rosa para Atraer</h5>
                        <p>8,50€</p>
                    </div>
