...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=123";
        ...
        $precio = "SELECT precio FROM productos WHERE id=123";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=123";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=123";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=123";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=172";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=123";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=123";
...
<head>
    ...
    <title>Místico - Oráculo de las 7 Energías </title>
</head>
<body>
