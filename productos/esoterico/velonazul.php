...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=142";
        ...
        $precio = "SELECT precio FROM productos WHERE id=142";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=142";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=142";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=142";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=191";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=142";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=142";
...
<head>
    ...
    <title>Místico - Velón Azul para Salud y Sanación</title>
</head>
<body>
