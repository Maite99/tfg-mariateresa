...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=134";
        ...
        $precio = "SELECT precio FROM productos WHERE id=134";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=134";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=134";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=134";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=183";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=134";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=134";
...
<head>
    ...
    <title>Místico - Agua de Luna</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Agua de Florida Murray & Lanman</h5>
                        <p>12,50€</p>
                    </div>
