...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=141";
        ...
        $precio = "SELECT precio FROM productos WHERE id=141";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=141";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=141";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=141";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=190";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=141";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=141";
...
<head>
    ...
    <title>Místico - Velón Morado para Energía y Vitalidad</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Velón blanco para Claridad Mental</h5>
                        <p>8,50€</p>
                    </div>
