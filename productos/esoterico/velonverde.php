...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=137";
        ...
        $precio = "SELECT precio FROM productos WHERE id=137";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=137";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=137";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=137";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=186";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=137";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=137";
...
<head>
    ...
    <title>Místico - Velón Verde para Protección</title>
</head>
<body>
