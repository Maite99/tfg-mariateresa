...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=29";
        ...
        $precio = "SELECT precio FROM productos WHERE id=29";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=29";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=29";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=29";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=49";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=50";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=29";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=29";
...
<head>
    ...
    <title>Místico - Corazón Selenita Natural</title>
</head>
<body>
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="formacorazoncuarzorosa.php">
                            <img src="../../img/mineral-forma-luna.jpg"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Luna de Cuarzo Rosa Natural</h5>
                        <p>10,00€</p>
                    </div>
