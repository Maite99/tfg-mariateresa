...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=31";
        ...
        $precio = "SELECT precio FROM productos WHERE id=31";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=31";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=31";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=31";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=52";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=31";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=31";
...
<head>
    ...
    <title>Místico - Punta Amazonita Granito</title>
</head>
<body>
