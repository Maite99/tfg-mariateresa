...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=44";
        ...
        $precio = "SELECT precio FROM productos WHERE id=44";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=44";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=44";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=44";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=75";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=76";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=44";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=44";
...
<head>
    ...
    <title>Místico - Rodado Onix Negro</title>
</head>
<body>
