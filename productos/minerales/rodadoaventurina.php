...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=41";
        ...
        $precio = "SELECT precio FROM productos WHERE id=41";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=41";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=41";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=41";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=71";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=72";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=41";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=41";
...
<head>
    ...
    <title>Místico - Rodado Aventurina</title>
</head>
<body>
