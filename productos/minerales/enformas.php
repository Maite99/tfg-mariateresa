                 ...
                 <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                     <div class="carousel-inner carrusel-principal mb-5">
                         <div class="carousel-item active">
                             <img src="../../img/portada-enforma.png" class="d-block w-100 img-carrusel" style="width: 800px; height: auto;" alt="...">
                         </div>
                     </div>
                 </div>
             <!-- FINAL FOTO -->
                     ...
                     <div class="row">
                         <div class="col-12 ps-lg-5 ">
                             <div class="caja-texto-productos">
                                 <h2>🔮 Encanto Mineral en Forma</h2>
                                 <p class="mt-lg-2 texto1-productos">Descubre la magia de los minerales en formas únicas que fusionan la energía terrenal con la belleza artística. Transforma tu entorno con estas piezas, desde obeliscos hasta esferas, que emanan una vibración calmante y equilibrada.</p>
                                 <p class="mt-lg-2 texto2-productos"> Embellece tu vida diaria con su presencia, recordándote la serenidad y la conexión con lo esencial.</p>
                 ...
                 <div class="container">
                     ...
                     <div class="row  d-flex flex-row ">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="formacorazonselenita.php">
                                 <img src="../../img/mineral-forma-corazon.jpeg"  alt="" class="imagenesproductos">
                             </a>
                             <h6 class="texto-productos mt-2">Corazón de Selenita Natural</h6>
                             <p class="precio">13,50€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="formacorazoncuarzorosa.php">
                                 <img src="../../img/mineral-forma-luna.jpg"  alt="" class="imagenesproductos">
                             </a>
                             <h6 class="texto-productos mt-2">Luna de Cuarzo Rosa Natural</h6>
                             <p class="precio">10,00€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="formapuntaamazonita.php">
                                 <img src="../../img/mineral-forma-punta.jpeg"  alt="" class="imagenesproductos">
                             </a>
                             <h6 class="texto-productos mt-2">Punta de Amazonita Granito</h6>
                             <p class="precio">25,00€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="formapiramideshungita.php">
                                 <img src="../../img/mineral-forma-piramide.jpg"  alt="" class="imagenesproductos">
                             </a>
                             <h6 class="texto-productos mt-2">Piramide de Shungita Natural</h6>
                     ...
                     <div class="row  d-flex flex-row mt-2">
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="formaesferaselenita.php">
                                 <img src="../../img/mineral-forma-esfera.jpg"  alt="" class="imagenesproductos">
                             </a>
                             <h6 class="texto-productos mt-2">Esfera de Selenita Natural </h6>
                             <p class="precio">21,60€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="formarejilla7chackras.php">
                                 <img src="../../img/mineral-forma-rejilla7chakras.jpeg"  alt="" class="imagenesproductos">
                             </a>
                             <h6 class="texto-productos mt-2">Rejilla Energética Redonda de Selenita Natural con 7 Chakras</h6>
                             <p class="precio">19,80€ </p>
                         </div>
 
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="formarejillaluna.php">
                                 <img src="../../img/mineral-forma-rejillafasesluna.jpeg"  alt="" class="imagenesproductos">
                             </a>
                             <h6 class="texto-productos mt-2">Rejilla Energética Redonda de Selenita Natural con Fases Lunares</h6>
                             <p class="precio">19,80€ </p>
                         </div>
                         ...
                         <div class="categoria-inciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                             <a href="formacuencoselenitaluna.php">
                                 <img src="../../img/mineral-forma-cuenco.jpeg"  alt="" class="imagenesproductos">
                             </a>
                             <h6 class="texto-productos mt-2">Cuenco de Selenita Grande Luna</h6>
