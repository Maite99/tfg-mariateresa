...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=38";
        ...
        $precio = "SELECT precio FROM productos WHERE id=38";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=38";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=38";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=38";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=65";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=66";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=38";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=38";
...
<head>
    ...
    <title>Místico - Rodado Amatista</title>
</head>
<body>
