...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=32";
        ...
        $precio = "SELECT precio FROM productos WHERE id=32";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=32";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=32";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=32";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=54";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=53";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=32";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=32";
...
<head>
    ...
    <title>Místico - Piramide Shungita Natural</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Rejilla Energética Redonda de Selenita Natural con 7 Chakras</h5>
                        <p>19,80€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Rejilla Energética Redonda de Selenita Natural con Fases Lunares</h5>
                        <p>19,80€</p>
                    </div>
