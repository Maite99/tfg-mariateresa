...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=45";
        ...
        $precio = "SELECT precio FROM productos WHERE id=45";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=45";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=45";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=45";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=77";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=78";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=45";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=45";
...
<head>
    ...
    <title>Místico - Rodado Fluorita Natural</title>
</head>
<body>
