...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=36";
        ...
        $precio = "SELECT precio FROM productos WHERE id=36";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=36";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=36";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=36";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=61";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=62";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=36";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=36";
...
<head>
    ...
    <title>Místico - Cuenco Luna Selenita</title>
</head>
<body>
