...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=39";
        ...
        $precio = "SELECT precio FROM productos WHERE id=39";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=39";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=39";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=39";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=67";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=68";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=39";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=39";
...
<head>
    ...
    <title>Místico - Rodado Cuarzo Rosa</title>
</head>
<body>
