...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=33";
        ...
        $precio = "SELECT precio FROM productos WHERE id=33";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=33";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=33";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=33";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=55";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=56";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=33";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=33";
...
<head>
    ...
    <title>Místico - Esfera Selenita Natural</title>
</head>
<body>
