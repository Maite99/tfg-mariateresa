...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=37";
        ...
        $precio = "SELECT precio FROM productos WHERE id=37";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=37";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=37";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=37";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=63";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=64";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=37";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=37";
...
<head>
    ...
    <title>Místico - Rodado Cuarzo Ahumado</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Rodado pulido de Amatista</h5>
                        <p>3,50€</p>
                    </div>
                    ...
                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Rodado pulido de Cuarzo Rosa</h5>
                        <p>3,50€</p>
                    </div>
