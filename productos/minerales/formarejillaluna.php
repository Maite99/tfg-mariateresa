...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=35";
        ...
        $precio = "SELECT precio FROM productos WHERE id=35";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=35";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=35";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=35";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=59";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=60";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=35";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=35";
...
<head>
    ...
    <title>Místico - Rejilla Enérgica Selenita Fases Lunares</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Piramide de Shungita Natural</h5>
                        <p>20,50€</p>
                    </div>

                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="formaesferaselenita.php">
                            <img src="../../img/mineral-forma-esfera.jpg"alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Esfera de Selenita Natural</h5>
                        <p>21,60€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="formapuntaamazonita.php">
                            <img src="../../img/mineral-forma-punta.jpeg"  alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Punta de Amazonita Granito</h5>
                        <p>25,00€</p>
                    </div>

                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        <a href="formacuencoselenitaluna.php">
                            <img src="../../img/mineral-forma-cuenco.jpeg"alt="" class="imagenescategorias">
                        </a>
                        <h5 class="texto-categorias mt-2">Cuenco de Selenita Grande Luna</h5>
                        <p>21,00€</p>
                    </div>
