...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=34";
        ...
        $precio = "SELECT precio FROM productos WHERE id=34";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=34";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=34";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=34";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=57";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=58";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=34";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=34";
...
<head>
    ...
    <title>Místico - Rejilla Enérgica Selenita 7 Chakras</title>
</head>
<body>
