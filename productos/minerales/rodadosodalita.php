...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=40";
        ...
        $precio = "SELECT precio FROM productos WHERE id=40";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=40";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=40";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=40";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=69";
            ...
            $imagen2 = "SELECT ruta FROM imagenes WHERE id=70";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=40";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=40";
...
<head>
    ...
    <title>Místico - Rodado Sodalita</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <div class="row  d-flex flex-row ">
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Rodado pulido de Aventurina</h5>
                        <p>3,50€</p>
                    </div>
                    ...
                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Rodado pulido de Cuazo Blanco</h5>
                        <p>3,50€</p>
                    </div>
                    ...
                    <div class="categoria-cristalesyminerales col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Rodado pulido de Onix Negro</h5>
                        <p>2,80€</p>
                    </div>
                    ...
                    <div class="categoria-portainciensos col-lg-3 col-md-6 col-sm-6 mr-2">
                        ...
                        <h5 class="texto-categorias mt-2">Rodado pulido de Fluorita Natural</h5>
                        <p>3,60€</p>
                    </div>
