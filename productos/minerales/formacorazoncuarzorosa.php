...
session_start();
        ...
        $titulo = "SELECT nombre FROM productos WHERE id=30";
        ...
        $precio = "SELECT precio FROM productos WHERE id=30";
        ...
        $descripcion = "SELECT descripcion FROM productos WHERE id=30";
        ...
        $descripcion2 = "SELECT descripcion2 FROM productos WHERE id=30";
            ...
            // SENTENCIA PARA OBTENER LA INFORMACION GENERAL DEL PRODUCTO 
                $informacion_general = "SELECT informacion_general FROM productos WHERE id=30";
            ...
            $imagen1 = "SELECT ruta FROM imagenes WHERE id=51";
            ...
            $producto_id = "SELECT id FROM productos WHERE id=30";
            ...
            $cantidad_stock = "SELECT cantidad_stock FROM productos WHERE id=30";
...
<head>
    ...
    <title>Místico - Luna Cuaro Rosa Natural</title>
</head>
<body>
