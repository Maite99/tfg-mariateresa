                ...
                <div class="row">
                    <div class="col-12 ps-lg-5 ">
                        <div class="caja-texto-productos">
                            ...
                            <p class="mt-lg-2 texto1-productos">Te enviaremos un correo electrónico para restablecer tu contraseña</p>
                        </div>   
                    </div>
                </div>
            </div>
                            ...
                            <h3 class="text-center mb-4 titulo-login">Inicio de sesión</h3>
                                <form action="/procesar_formulario" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control email-olvidaste mb-3" id="email-olvidaste" name="email">
                                    </div>

                                    <button type="submit" class=" botones-olvidaste btn btn-block mt-3 " style="background-color: #b0d688; color: white; width:180px">Enviar</button>
